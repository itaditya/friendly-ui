...
export const PeopleLoadingIcon: Component<IconProps> = (p) => {
  return (
    <svg
...
export const AddFriendIcon: Component<IconProps> = (p) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const PendingRequestIcon: Component<IconProps> = (p) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const RemoveFriendIcon: Component<IconProps> = (p) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const SearchHistoryIcon: Component<IconProps> = (p) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export const ClearSearchIcon: Component<IconProps> = (p) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
